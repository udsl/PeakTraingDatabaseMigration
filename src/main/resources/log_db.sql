...
DROP TABLE IF EXISTS TEMPLATES_INSERTED;
...
CREATE INDEX COMPANY_DELEGATE_IDX ON ATTENDEE_MAP(COMPANY_ID, DELEGATE_ID);
...
CREATE TABLE TEMPLATES_INSERTED
(
    ID bigint auto_increment,
...
CREATE INDEX INSERTED_BY_NAME_IDX ON TEMPLATES_INSERTED(TEMPLATE_NAME);
